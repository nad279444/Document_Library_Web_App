...
export default function Home({ message = "Welcome" }) {
  return (
    <>
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="max-w-4xl font-bold text-3xl sm:text-4xl md:text-6xl lg:text-7xl">
        Chat with your <span className="text-green-600">documents</span> in
        seconds.
      </h1>
      <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
        This Library allows you to have conversations with any PDF document.
     ...
     <div>
       ...
       {/* Feature section */}
      <div className='mx-auto mb-16 sm:mb:32 mt-32 max-w-5xl sm:mt-56'>
       ...
       {/* steps */}
       <ol className='my-8 space-y-12 pt-8 md:flex md:space-x-12 md:space-y-0 sm:mx-20 sm:my-8'>
